        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaEmision = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dt_Pedido_Productos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dt_Pedido_Productos_Pedidos_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dt_Pedido_Productos_Productos_ProductoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dt_Pedido_Productos_PedidoId",
                table: "Dt_Pedido_Productos",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_Dt_Pedido_Productos_ProductoId",
                table: "Dt_Pedido_Productos",
                column: "ProductoId");
